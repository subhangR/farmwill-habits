...
class _CreateGoalPageState extends ConsumerState<CreateGoalPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _saveGoal() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Goal ${widget.existingGoal != null ? 'updated' : 'created'} successfully'),
      ...
      body: isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.existingGoal != null ? 'Updating Goal...' : 'Creating Goal...',
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: Icon(
                    widget.existingGoal != null ? Icons.edit_note : Icons.flag_rounded,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.checklist, color: Colors.blue.shade400),
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(
                            widget.existingGoal != null ? Icons.update : Icons.add,
                            size: 20,
                          ),
                          const SizedBox(width: 8),
                          Text(
